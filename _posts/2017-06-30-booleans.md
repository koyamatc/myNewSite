...
<button id="button1" onclick="processClick1(event)">Button1</button>
<div id="myDiv" onclick="processClick1(event)">Click also on this div!</div>
<div id="clicks"></div>
<script>
window.onclick = processClick1;

function processClick1s(evt) {
  var clicks = document.querySelector('#clicks');
